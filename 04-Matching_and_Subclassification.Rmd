...
#### Questions
- Using the simple difference in outcomes, how much does the probability of survival increase for first-class passengers?
- After conditioning on gender and age, what happens to the differnce in probability of survival between first-class and non-first-class passengers?
